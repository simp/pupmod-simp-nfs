    ...
    on_supported_os.each do |os, facts|
      ...
      context "on #{os}" do
        ...
        context 'base' do
          ...
          it { is_expected.to_not create_iptables__listen__tcp_stateful("nfs4_callback_port") }
        ...
        context 'with firewall = true' do
          ...
          it { is_expected.to create_iptables__listen__tcp_stateful("nfs4_callback_port") }
        end
      end
    end
  end
